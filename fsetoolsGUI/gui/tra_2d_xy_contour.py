...
from fsetoolsGUI.gui.bases.custom_table import TableModel
from fsetoolsGUI.gui.layouts.i0406_tra_2d_xy_contour import Ui_MainWindow
...
class App(AppBaseClass):
    ...
    def init_table(self):
        ...
        self.TableModel_emitters = TableModel(self)
        self.TableModel_emitters.update_model(content_data=emitter_list_default, col_headers=emitter_list_header)
        ...
        self.TableModel_receivers = TableModel(self)
        self.TableModel_receivers.update_model(content_data=receiver_list_default, col_headers=receiver_list_header)
