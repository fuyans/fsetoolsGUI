...
class BR187SimpleBaseClass(AppBaseClass):
    ...
    def init_ui(self):
        ...
        self.add_lineedit_set_to_grid(self.ui.p2_layout, 10, 'p2_out_S_or_UA', 'Allowable unprotected area', '%')
...
class BR187ComplexBaseClass(AppBaseClass):
    ...
    def __init__(self, parent=None, post_stats: bool = True, *args, **kwargs):
        ...
        self.add_lineedit_set_to_grid(self.ui.p2_layout, c.count, 'p2_in_half_S', '½S, emitter to boundary', 'm', descrip_cls='QRadioButton')
        self.add_lineedit_set_to_grid(self.ui.p2_layout, c.count, 'p2_in_unprotected_area', 'Unprotected area', '%', descrip_cls='QRadioButton')
