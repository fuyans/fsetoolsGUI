...
from fsetoolsGUI.gui.images_base64 import dialog_0402_br187_perpendicular_figure_1 as figure_1
...
class Dialog0402(QMainWindow):
    ...
    def __init__(self, parent=None):
        # instantiation
        super().__init__(parent=parent, title='BR 187 Thermal Radiation Calculation (Rectangle and Perpendicular)')
