...
class App(AppBaseClass):
    ...
    def __init__(self, parent=None):
        ...
        self.add_widget_to_grid(self.ui.p2_grid, 1, 'p2_entry_1', 'test description 1', 'unit 1')
        self.add_widget_to_grid(self.ui.p2_grid, 2, 'p2_entry_2', 'test description 2', 'unit 2')
        self.add_widget_to_grid(self.ui.p2_grid, 3, 'p2_entry_3', 'test description 3', 'unit 3')
        self.add_widget_to_grid(self.ui.p2_grid, 4, 'p2_entry_4', 'test description 4', 'unit 4')
        self.add_widget_to_grid(self.ui.p2_grid, 5, 'p2_entry_5', 'test description 5', 'unit 5')
        self.add_widget_to_grid(self.ui.p2_grid, 6, 'p2_entry_6', 'test description 6', 'unit 6')
        self.add_widget_to_grid(self.ui.p2_grid, 7, 'p2_entry_7', 'test description 7', 'unit 7')
        self.add_widget_to_grid(self.ui.p2_grid, 8, 'p2_entry_8', 'test description 8', 'unit 8')
