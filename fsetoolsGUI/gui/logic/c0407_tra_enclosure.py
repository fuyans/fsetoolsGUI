...
class App(AppBaseClass):
    ...
    def init_ui(self):
        ...
        self.ui.p1_grid.addWidget(self.ui.p1_description)
        self.ui.p1_grid.addWidget(self.ui.p1_figure)

        self.ui.p2_grid = QGridLayout(self.ui.page_2)
        self.ui.p2_grid.addWidget(QLabel('<b>Inputs</b>'), 0, 0, 1, 3)
        self.add_widget_to_grid(self.ui.p2_grid, 1, 'in_width', 'Width', 'm')
        self.add_widget_to_grid(self.ui.p2_grid, 2, 'in_depth', 'Width', 'm')
        self.add_widget_to_grid(self.ui.p2_grid, 3, 'in_height', 'Width', 'm')
        self.add_widget_to_grid(self.ui.p2_grid, 4, 'in_mesh_resolution', 'Mesh resolution', 'm')
        self.ui.in_mesh_resolution.setToolTip('Equivalent to mesh resolution, proportionate to results accuracy')
        self.add_widget_to_grid(self.ui.p2_grid, 5, 'in_wall_1_heat_flux', 'Wall 1 heat flux', 'kW/m²')
        self.add_widget_to_grid(self.ui.p2_grid, 6, 'in_wall_2_heat_flux', 'Wall 2 heat flux', 'kW/m²')
        self.add_widget_to_grid(self.ui.p2_grid, 7, 'in_wall_3_heat_flux', 'Wall 3 heat flux', 'kW/m²')
        self.add_widget_to_grid(self.ui.p2_grid, 8, 'in_wall_4_heat_flux', 'Wall 4 heat flux', 'kW/m²')
        self.add_widget_to_grid(self.ui.p2_grid, 9, 'in_floor_heat_flux', 'Floor heat flux', 'kW/m²')
        self.ui.p2_grid.addWidget(QLabel('<b>Outputs</b>'), 10, 0, 1, 3)
        self.add_widget_to_grid(self.ui.p2_grid, 11, 'out_max_heat_flux', 'Maximum heat flux', 'kW/m²')
