...
class Dialog0401(QMainWindow):
    ...
    fp_doc = join(fsetoolsGUI.__root_dir__, 'gui', 'docs', '0401.md')  # doc file path
    ...
    def __init__(self, parent=None):
        ...
        self.ui.label_image_page.setPixmap(join(fsetoolsGUI.__root_dir__, 'gui', 'images', '0401-0.png'))
        self.ui.label_image_figure.setPixmap(join(fsetoolsGUI.__root_dir__, 'gui', 'images', '0401-1.png'))
