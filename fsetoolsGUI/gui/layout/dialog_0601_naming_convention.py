...
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(tooltip)
        self.pushButton_copy.setToolTip(QCoreApplication.translate("MainWindow", u"Click (or press Enter) to copy the generated file name.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.pushButton_copy.setStatusTip(QCoreApplication.translate("MainWindow", u"Click (or press Enter) to copy the generated file name.", None))
#endif // QT_CONFIG(statustip)
